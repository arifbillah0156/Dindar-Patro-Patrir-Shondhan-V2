...
const ContactForm = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white shadow-md rounded-md mt-14">
      ...
      <div className="w-full text-center">
        <Link
          ...
          className="p-4 text-xl md:text-2xl bg-purple-100 text-purple-700 rounded-md shadow-md text-center underline underline-offset-4 block"
        >
      ...
      <br />
      <div className="w-full text-center">
        <span className="p-4 text-2xl bg-blue-100 text-blue-700 rounded-md shadow-md block">
          নিচের ফরমের মাধ্যমে আমাদের কাছে মেসেজ পাঠান
        </span>
      </div>
      <br />
      <br />
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label
            htmlFor="name"
            className="block text-lg font-medium text-purple-800"
          >
            নাম
          </label>
          <input
